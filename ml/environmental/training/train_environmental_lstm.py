"""
Deterministic Training Pipeline for Polarix Environmental LSTM (Polarix SIH26060 - Person C).
...
- Trains a multi-target multi-horizon PyTorch LSTM with early stopping.
...
logger = logging.getLogger("TrainEnvironmentalLSTM")
...
def train_model(
    ...
    scaler_path = models_dir / "environmental_lstm_v1_scaler.json"
    ...
    logger.info(f"Instantiated EnvironmentalLSTM with {param_counts['total_parameters']} parameters")
    ...
    model_path = models_dir / "environmental_lstm_v1.pt"
    ...
    config = {
        "model_name": "environmental-lstm-v1",
        "model_type": "EnvironmentalLSTM",
    ...
    config_path = models_dir / "environmental_lstm_v1_config.json"
