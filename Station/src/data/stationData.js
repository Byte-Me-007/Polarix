...
export const STATIONS = {
  ...
  BHARATI: {
    ...
    // 3D Digital Twin configuration — BHARATI specific coastal spatial layout
    // Bharati: compact coastal station on rocky Larsemann Hills promontory, near Thala Fjord / Quilty Bay.
    // Spatial arrangement reflects real operational logistics: fuel farm separated, helipad open, coastal edge visible.
    //
    // Zone layout (scene units, top-down):
    //   MAIN:      pos [0, 6.5, 0]      size [28, 13, 20]  — compact elevated modular main building
    //   ENERGY:    pos [-26, 5.5, -22]  size [22, 11, 16]  — power management block, west side
    //   GENERATOR: pos [-26, 4.5, -44]  size [18,  9, 14]  — FUEL FARM area, separated south-west
    //   STORAGE:   pos [24, 5.0, -18]   size [18, 10, 14]  — container logistics cluster, east
    //   RESEARCH:  pos [34, 5.5, 6]     size [20, 11, 16]  — science area, east-north
    //   COMMS:     pos [6, 4.5, -46]    size [12,  9, 12]  — comms tower, south
    digitalTwin: {
      model: "procedural-parametric-bharati",
      elevationStilts: true,
      stationVariant: "BHARATI",
      zones: [
        { id: "Z-BHR-01", name: "MAIN BUILDING", code: "MAIN",      position: [0,    6.5,   0],   size: [28.0, 13.0, 20.0], shape: "box",      color: "#e8e2d8", status: "NOMINAL", description: "Compact multi-level modular main facility — operations hub, crew quarters, and command centre on elevated structural columns" },
        { id: "Z-BHR-02", name: "ENERGY",        code: "ENERGY",    position: [-26,  5.5, -22],   size: [22.0, 11.0, 16.0], shape: "box",      color: "#dbd5c8", status: "NOMINAL", description: "Microgrid power conditioning, LiFePO4 battery storage bank, solar inverter bus, and clean energy distribution" },
        { id: "Z-BHR-03", name: "RESEARCH",      code: "RESEARCH",  position: [34,   5.5,   6],   size: [20.0, 11.0, 16.0], shape: "box",      color: "#dbd5c8", status: "NOMINAL", description: "Cryosphere, oceanography, geomagnetism, atmospheric and coastal science instrumentation labs" },
        { id: "Z-BHR-04", name: "STORAGE",       code: "STORAGE",   position: [24,   5.0, -18],   size: [18.0, 10.0, 14.0], shape: "box",      color: "#d2ccc0", status: "NOMINAL", description: "Containerised logistics modules, scientific sample cryo-storage, field equipment depot, and provisions" },
        { id: "Z-BHR-05", name: "FUEL FARM",     code: "GENERATOR", position: [-26,  4.5, -44],   size: [18.0,  9.0, 14.0], shape: "box",      color: "#d5ccbc", status: "NOMINAL", description: "Separated fuel farm — HSD storage tanks, CHP generator plant, fuel transfer manifold, exhaust and waste heat recovery" },
        { id: "Z-BHR-06", name: "COMMS",         code: "COMMS",     position: [6,    4.5, -46],   size: [12.0,  9.0, 12.0], shape: "cylinder", color: "#b65a1f", status: "NOMINAL", description: "GSAT-30 Starlink polar gateway, earth observation L-band downlink antenna, and telemetry communications shelter" }
      ],
      sensors: []
    },

    // Comprehensive sensor registry — BHARATI spatial positions match new coastal zone layout
    sensors: [
      { id: "ENV-BHR-001", zone: "COMMS",     name: "Larsemann Hills Optical Anemometer", domain: "ENVIRONMENT", type: "WIND_SPEED",   value: 26.4,  unit: "km/h",  status: "NORMAL",  quality: "GOOD", lastUpdate: "19:28:10 UTC", criticality: "HIGH",   minValue: 0.0,   maxValue: 180.0,  x:  6.0,  y: 18.0, z: -46.0 },
      { id: "ENV-BHR-002", zone: "MAIN",      name: "Surface Temperature Array",           domain: "ENVIRONMENT", type: "TEMPERATURE",  value: -12.6, unit: "°C",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:28:08 UTC", criticality: "HIGH",   minValue: -45.0, maxValue: 15.0,   x:  8.0,  y: 6.5,  z:  5.0  },
      { id: "ENV-BHR-003", zone: "MAIN",      name: "Digital Microbarometer",              domain: "ENVIRONMENT", type: "PRESSURE",     value: 994.5, unit: "hPa",  status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:50 UTC", criticality: "MEDIUM", minValue: 930.0, maxValue: 1050.0, x: -8.0,  y: 6.5,  z:  3.0  },
      { id: "ENV-BHR-004", zone: "RESEARCH",  name: "Larsemann Met Mast Humidity",         domain: "ENVIRONMENT", type: "HUMIDITY",     value: 64.0,  unit: "%",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:00 UTC", criticality: "MEDIUM", minValue: 10.0,  maxValue: 100.0,  x:  38.0, y: 5.5,  z:  6.0  },
      { id: "ENV-BHR-005", zone: "MAIN",      name: "Cryosphere Sub-Ice Thermistor",       domain: "ENVIRONMENT", type: "TEMPERATURE",  value: -18.6, unit: "°C",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:10 UTC", criticality: "LOW",   minValue: -40.0, maxValue: 0.0,    x:  0.0,  y: 0.2,  z:  22.0 },
      { id: "ENG-BHR-001", zone: "ENERGY",    name: "Clean Microgrid Solar Bus",           domain: "ENERGY",       type: "POWER",        value: 54.2,  unit: "kW",   status: "NORMAL",  quality: "GOOD", lastUpdate: "19:28:04 UTC", criticality: "HIGH",   minValue: 0.0,   maxValue: 80.0,   x: -26.0, y: 5.5,  z: -22.0 },
      { id: "ENG-BHR-002", zone: "ENERGY",    name: "Lithium Iron Phosphate Battery SOH",  domain: "ENERGY",       type: "HEALTH",       value: 99.4,  unit: "%",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:28:00 UTC", criticality: "HIGH",   minValue: 70.0,  maxValue: 100.0,  x: -22.0, y: 5.5,  z: -22.0 },
      { id: "ENG-BHR-003", zone: "RESEARCH",  name: "Wind Turbine #2 Pitch Actuator",      domain: "ENERGY",       type: "ANGLE",        value: 14.5,  unit: "deg",  status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:35 UTC", criticality: "MEDIUM", minValue: 0.0,   maxValue: 90.0,   x:  46.0, y: 5.5,  z:  2.0  },
      { id: "ENG-BHR-004", zone: "ENERGY",    name: "Main Bus Power Factor Transducer",    domain: "ENERGY",       type: "POWER",        value: 0.98,  unit: "cos φ",status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:25 UTC", criticality: "MEDIUM", minValue: 0.8,   maxValue: 1.0,    x: -30.0, y: 5.5,  z: -22.0 },
      { id: "ENG-BHR-005", zone: "GENERATOR", name: "CHP Fuel Farm Generator Load",        domain: "ENERGY",       type: "POWER",        value: 15.6,  unit: "kW",   status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:15 UTC", criticality: "HIGH",   minValue: 0.0,   maxValue: 45.0,   x: -26.0, y: 4.5,  z: -44.0 },
      { id: "STR-BHR-001", zone: "MAIN",      name: "Integrated Pod Aerodynamic Load",     domain: "STRUCTURE",    type: "LOAD",         value: 38.2,  unit: "kN",   status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:42 UTC", criticality: "HIGH",   minValue: 0.0,   maxValue: 250.0,  x:  0.0,  y: 6.5,  z:  8.0  },
      { id: "STR-BHR-002", zone: "RESEARCH",  name: "Structural Joint Expansion Gauge",    domain: "STRUCTURE",    type: "DISPLACEMENT",  value: 0.85, unit: "mm",   status: "NORMAL",  quality: "GOOD", lastUpdate: "19:26:50 UTC", criticality: "LOW",   minValue: 0.0,   maxValue: 5.0,    x:  20.0, y: 3.2,  z:  4.0  },
      { id: "STR-BHR-003", zone: "MAIN",      name: "Modular Pod Column Torsion Strain",   domain: "STRUCTURE",    type: "STRAIN",       value: 112.0, unit: "με",   status: "NORMAL",  quality: "GOOD", lastUpdate: "19:26:40 UTC", criticality: "HIGH",   minValue: 0.0,   maxValue: 700.0,  x: -12.0, y: 0.8,  z:  6.0  },
      { id: "STR-BHR-004", zone: "ENERGY",    name: "Energy Block Vibration Sensor",       domain: "STRUCTURE",    type: "VIBRATION",    value: 1.2,   unit: "mm/s", status: "NORMAL",  quality: "GOOD", lastUpdate: "19:26:30 UTC", criticality: "MEDIUM", minValue: 0.0,   maxValue: 4.0,    x: -26.0, y: 3.5,  z: -30.0 },
      { id: "LOG-BHR-001", zone: "STORAGE",   name: "Primary Polar Diesel Reserve",        domain: "LOGISTICS",    type: "LEVEL",        value: 84.0,  unit: "%",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:15 UTC", criticality: "HIGH",   minValue: 20.0,  maxValue: 100.0,  x:  24.0, y: 5.0,  z: -18.0 },
      { id: "LOG-BHR-002", zone: "GENERATOR", name: "Fuel Farm Tank Level Sensor",         domain: "LOGISTICS",    type: "FLOW",         value: 42.0,  unit: "L/min",status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:00 UTC", criticality: "MEDIUM", minValue: 10.0,  maxValue: 60.0,   x: -30.0, y: 2.8,  z: -44.0 },
      { id: "LOG-BHR-003", zone: "STORAGE",   name: "Potable RO Water Buffer Tank",        domain: "LOGISTICS",    type: "LEVEL",        value: 91.0,  unit: "%",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:26:50 UTC", criticality: "HIGH",   minValue: 25.0,  maxValue: 100.0,  x:  28.0, y: 5.0,  z: -15.0 },
      { id: "LOG-BHR-004", zone: "STORAGE",   name: "Deep Core Ice Sample Cryo Locker",    domain: "LOGISTICS",    type: "TEMPERATURE",  value: -32.4, unit: "°C",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:26:15 UTC", criticality: "HIGH",   minValue: -45.0, maxValue: -20.0,  x:  20.0, y: 5.0,  z: -24.0 },
      { id: "COM-BHR-001", zone: "COMMS",     name: "GSAT-30 Starlink Gateway Antenna",    domain: "CONNECTIVITY", type: "SIGNAL",       value: 98.0,  unit: "%",    status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:20 UTC", criticality: "HIGH",   minValue: 50.0,  maxValue: 100.0,  x:  6.0,  y: 13.0, z: -42.0 },
      { id: "COM-BHR-002", zone: "COMMS",     name: "Earth Observation L-Band Downlink",   domain: "CONNECTIVITY", type: "BANDWIDTH",    value: 45.0,  unit: "Mbps", status: "NORMAL",  quality: "GOOD", lastUpdate: "19:27:05 UTC", criticality: "HIGH",   minValue: 10.0,  maxValue: 80.0,   x:  10.0, y: 4.5,  z: -46.0 }
    ]
  }
};
